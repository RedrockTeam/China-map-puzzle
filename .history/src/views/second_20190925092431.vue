<template>
  <div class="game">
    ...
    <div class="main" ref="main">
      <div class="piece chosen first" ref="pic" data-index="1">1</div>
      <div class="piece second" ref="pic" data-index="2">2</div>
      <div class="piece third" ref="pic" data-index="3">3</div>
      <div class="piece four" ref="pic" data-index="4">4</div>
      <div class="piece five" ref="pic" data-index="5">5</div>
      <div class="piece six" ref="pic" data-index="6">6</div>
      <div class="piece seven" ref="pic" data-index="7">7</div>
      <div class="piece eight" ref="pic" data-index="8">8</div>
      <div class="piece nine" ref="pic" data-index="9">9</div>
    </div>
